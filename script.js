(function(){
    ...
    var spanList = document.getElementsByClassName('main__block__p8__span1');
...
function changeState(blockList) {
    ...
    for (i=0; i < blockList.length; i++){
        if (blockList[i].classList.contains('selected')) {
            blockList[i].parentElement.getElementsByClassName('main__block__p8_selected')[0].style.display = 'block';
            blockList[i].parentElement.getElementsByClassName('main__block__p8')[0].style.display = 'none';
            blockList[i].parentElement.getElementsByClassName('main__block__p8_disabled')[0].style.display = 'none';
        }
        else if (blockList[i].classList.contains('disabled')) {
            blockList[i].parentElement.getElementsByClassName('main__block__p8_disabled')[0].style.display = 'block';
            blockList[i].parentElement.getElementsByClassName('main__block__p8')[0].style.display = 'none';
            blockList[i].parentElement.getElementsByClassName('main__block__p8_selected')[0].style.display = 'none';
        }
        else {
            blockList[i].parentElement.getElementsByClassName('main__block__p8')[0].style.display = 'block';
            blockList[i].parentElement.getElementsByClassName('main__block__p8_selected')[0].style.display = 'none';
            blockList[i].parentElement.getElementsByClassName('main__block__p8_disabled')[0].style.display = 'none';
        }
